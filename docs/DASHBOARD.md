...
| `/settings` | The leave-notification toggle, the [global font](#the-global-font), the register-gate/registration-tier roles and the "rules accepted" detection method, and current session info (including your dashboard role). |
